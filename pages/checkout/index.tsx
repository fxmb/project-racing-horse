...
export default function Checkout() {
  ...
  const removeProductFromCheckout = (product: Product) => {
    const updatedProducts = checkoutProducts.filter(
      (currentProduct: Product) => currentProduct.objectID != product.objectID
    );
          ...
          <form className="lg:grid lg:grid-cols-2 lg:gap-x-12 xl:gap-x-16">
            ...
            <div className="mt-10 lg:mt-0">
              ...
              <div className="mt-4 rounded-lg border border-gray-200 bg-white shadow-sm">
                <h3 className="sr-only">Produkte im Warenkorb</h3>
                <ul role="list" className="divide-y divide-gray-200">
                  {checkoutProducts?.map((product: Product) => (
                    <li
                    ...
                    >
                      <div className="flex-shrink-0">
                        <img
                          ...
                          alt={product.product_details.keyword.join(" ")}
                      ...
                      <div className="ml-6 flex flex-1 flex-col">
                        <div className="flex">
                          <div className="min-w-0 flex-1">
                            ...
                            <p className="mt-1 text-sm text-gray-500">
                              {product.product_details.keyword}
                            </p>
                        ...
                        <div className="flex flex-1 items-end justify-between pt-2">
                          <p className="mt-1 text-sm font-medium text-gray-900">
                            {
                              product.product_price_details.product_price
                                .price_amount
                            }{" "}
                            €
                          </p>
